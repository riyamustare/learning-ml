...
class Sentence:
    ...
    def mark_mine(self, cell):
        """Updates internal knowledge representation given the fact that a cell is a mine."""
        if cell in self.cells:
            self.cells.remove(cell)
            self.count -= 1

    def mark_safe(self, cell):
        """Updates internal knowledge representation given the fact that a cell is safe."""
        if cell in self.cells:
            self.cells.remove(cell)
...
class MinesweeperAI:
    ...
    def mark_mine(self, cell):
        """Marks a cell as a mine, and updates all knowledge to mark that cell as a mine."""
        self.mines.add(cell)
        for sentence in self.knowledge:
            sentence.mark_mine(cell)

    def mark_safe(self, cell):
        """Marks a cell as safe, and updates all knowledge to mark that cell as safe."""
        self.safes.add(cell)
        for sentence in self.knowledge:
    ...
    def add_knowledge(self, cell, count):
        ...
        how many neighboring cells contain mines.
        """
    ...
    def update_knowledge(self):
        """Updates the AI's knowledge base, marking cells as safe or as mines when possible."""
        changes = True
        while changes:
            changes = False
            safes = set()
